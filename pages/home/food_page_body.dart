...
import 'package:gospela1/controllers/recommended_product_controller.dart';
...
import 'package:gospela1/widgets/icon_and_text_widget.dart';
          ...
          child: Row(
            ...
            children: [
              ...
              Container(
                ...
                child: SmallText(text: 'Computing'),
              )
            ],
          ),
        ),
        //recommended computer
        //list of computing and images
              ...
              ? ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return GestureDetector(
                      onTap: () {
                        Get.toNamed(
                            RouteHelper.getRecommendedComputer(index, 'home'));
                      },
                      child: Container(
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    SmallText(text: 'With Apple Refurbished'),
                                    SizedBox(
                                      height: Dimensions.height10,
                                    ),
                                    Row(
    ...
    return Transform(
      ...
      child: Stack(
        children: [
          GestureDetector(
            onTap: () {
              Get.toNamed(RouteHelper.getPopularComputer(index, 'home'));
            },
            child: Container(
