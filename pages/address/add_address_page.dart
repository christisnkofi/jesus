...
import 'package:gospela1/controllers/user_controller.dart';
import 'package:gospela1/models/address_model.dart';
...
class _AddAddressPageState extends State<AddAddressPage> {
  ...
  CameraPosition _cameraPosition =
      const CameraPosition(target: LatLng(7.946527, -1.023194), zoom: 17);
  late LatLng _initialPosition = LatLng(7.946527, -1.023194);
                      ...
                      GestureDetector(
                        onTap: () {
                          AddressModel _addressModel = AddressModel(
                            addressType: locationController.addressList[
